...
# slice convention.  They have been ported to the current left-to-right
# convention via Tangle.from_legacy (see KhT/CrossingTangle.py:_reverse_slices).

name1 = "../Output/trefoil_linked_with_line"
Tangle1 = Tangle.from_legacy("cup0.pos1.neg2.pos1.neg0.neg1.pos2.cap3.cap1")
...
Tangle2 = Tangle.from_legacy("cup0.neg1.pos0.pos2.neg1.pos2.pos0.cap3.cap1")
...
Tangle3 = Tangle.from_legacy("cup1.pos2.pos0.pos0.neg1.neg1.pos2.neg1.pos0.cap3.cap1")
...
Tangle4 = Tangle.from_legacy("cup1.pos0.neg1.neg2.neg2.neg2.pos0.pos0.pos0.cap3.cap1")
...
Tangle7 = Tangle.from_legacy("cup1.pos0.neg1.neg2.neg2.pos0.pos0.cap3.cap1")
